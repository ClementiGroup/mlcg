...
associated physical properties. `AtomicData` instances also store the outputs of models through which they pass.

.. autoclass:: mlcg.data.atomic_data.AtomicData
