...
from mlcg.nn.prior.repulsion import FastCutoffExpRepulsion
...
def test_fast_cutoff_exp_repulsion_and_nvalchemi_nls_match_reference(
    ...
    model = torch.load(
        os.path.join(ASSETS_DIR, "full_model.pt"), weights_only=False
    )
