...
def test_regularized_basis_forward(basis_type, num_rbf, n_basis_set, independent_regularizations):
...
def test_regularized_basis_symmetry(basis_type, n_basis_set, independent_regularizations, init_val):
    basis = RegularizedBasis(
