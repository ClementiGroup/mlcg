...
data_yaml = _here / "h5_pl/multiple_molecules/train_demo_cuda.yaml"
...
@pytest.mark.parametrize(
    "model_yaml,reference_data_yaml,priors,struct,sim_yaml",
    [
        (training_yaml, data_yaml, priors, struct, sim_yaml)
        for training_yaml in training_yaml_list
    ],
)
def test_training_simulate_examples(
    model_yaml, reference_data_yaml, priors, struct, sim_yaml, test_dir
):
    # Setup training yaml
