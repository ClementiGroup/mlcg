...
class QuarticBonds(Polynomial):
    ...
    (order 2 Polynomial priors of degree 4)
    """

    def __init__(self, statistics, name="bonds", n_degs: int = 4) -> None:
        super(QuarticBonds, self).__init__(
            statistics, name, order=2, n_degs=n_degs
        )
        self.name = name
        print(name)
